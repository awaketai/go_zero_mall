...
type (
	...
	DeatilResponse = product.DeatilResponse
...
func (m *defaultProduct) Deatil(ctx context.Context, in *DetailRequest, opts ...grpc.CallOption) (*DeatilResponse, error) {
	client := product.NewProductClient(m.cli.Conn())
	return client.Deatil(ctx, in, opts...)
}
